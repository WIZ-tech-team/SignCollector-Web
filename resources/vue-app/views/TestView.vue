      ...
      <div class="bg-white w-11/12 h-5/6 rounded-lg shadow-lg relative overflow-hidden">
        ...
        <div class="flex h-full">
          ...
          <div class="w-1/3 p-4 py-8">
            ...
            <!-- Details Attributes -->
            <DetailedSignForm :detailed-sign="activeSign" :is-edit="false"></DetailedSignForm>
          </div>
        ...
        <form @submit.prevent="submitEditUpdate" class="flex h-full">
          ...
          <div class="w-1/3 p-4 py-8 overflow-hidden space-y-4">
            ...
            <div class="overflow-auto h-[90%]">
                <DetailedSignForm :detailed-sign="editActiveSign" :is-edit="true"></DetailedSignForm>
            </div>
          </div>
...
import DetailedSignForm from '@/components/form/forms/DetailedSignForm.vue';
